...
from .routers import source_data, source_data_stream, events, events_stream, analyst, condition_group, dashboard, control, trades, quantitatives, auth, best_window
...
app.include_router(best_window.router)
